...
A builder can be created using `BootstrapViewElements.bootstrap.builders.options()` factory methods.
...
BootstrapViewElements.bootstrap.builders
    .options()
    .controlName( "demo" )
    .add( BootstrapViewElements.bootstrap.builders.option().label( "Orange" ).value( "orange" ) )
    .add( BootstrapViewElements.bootstrap.builders.option().label( "Apple" ).value( "apple" ) )
    .build();
----
